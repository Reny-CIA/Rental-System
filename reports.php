							...
							<div class="card border-primary">
								...
								<div class="card-footer">
									<div class="col-md-12">
										...
										<a href="download_pdf.php?type=payment" class="d-flex justify-content-between mt-2"> 
							...
							<div class="card border-primary">
								...
								<div class="card-footer">
									<div class="col-md-12">
										...
										<a href="download_pdf.php?type=balance" class="d-flex justify-content-between mt-2"> 
											<span>Download PDF</span> 
											<span class="fa fa-file-pdf-o"></span>
										</a>
									</div>
